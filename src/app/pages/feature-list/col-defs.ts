export class FeatureListColumnDefinition {
    ...
    gridOptions: any = {
        ...
        columnDefs: [
            {
                headerName: "Project", field: "projectName", enableRowGroup: true, width: 350, sort: 'asc',
            },
            { headerName: "Feature", field: "featureName", },
